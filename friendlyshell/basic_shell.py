"""Simple, generic interactive shell with online help and auto completion support"""
from friendlyshell.base_shell import BaseShell
from friendlyshell.shell_help_mixin import ShellHelpMixin
from friendlyshell.command_complete_mixin import CommandCompleteMixin, auto_complete_manager
...
class BasicShell(BaseShell, ShellHelpMixin, CommandCompleteMixin):
    ...
    def run(self):
        ...
        Input will be processed from the console to execute commands, until termination of the
        shell is invoked by the user via 'exit' or some other failure event."""
